...
import { renderOfflineProgressModal } from "./renderOfflineProgressModal.js";
...
export function renderModalInto(state, setState) {
  ...
  const offlineModal = renderOfflineProgressModal(state, setState);
  if (offlineModal) {
    shell.modalHost.append(offlineModal);
    return;
  }
