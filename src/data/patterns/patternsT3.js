...
import { averageAdjacentDifference, getConsecutiveEqualIndices, getDigitCounts, getDigits, getIndicesWithCount, getMultiplierDataPower, hasOutlierDigit, highlightAll, isPowerOfBase, sumDigits} from "../../core/helpers/patternHelpers.js";
import {
  FIBONACCI_SET,
  LUCAS_SET,
  TRIANGULAR_SET,
  ONE_SIDED_POLYOMINO_SET,
  PENTAGONAL_SET,
  HEXAGONAL_SET,
  TETRAHEDRAL_SET,
  CATALAN_SET,
  ...
  CAYLEY_TREE_SET,
  MARKOV_SET,
  HIGHLY_COMPOSITE_SET,
  HARMONIC_DIVISOR_SET,
  WEDDERBURN_ETHERINGTON_SET,
  isInSequence
} from "../../core/helpers/mathSequenceHelpers.js";

const MATH_SEQUENCE_PATTERNS = [
  { id: "PAT050108", name: "Fibonacci Number", sequenceSet: FIBONACCI_SET },
  { id: "PAT050109", name: "Lucas Number", sequenceSet: LUCAS_SET },
  { id: "PAT050110", name: "One-Sided Polyomino Number", sequenceSet: ONE_SIDED_POLYOMINO_SET },
  { id: "PAT050208", name: "Triangular Number", sequenceSet: TRIANGULAR_SET },
  { id: "PAT050209", name: "Pentagonal Number", sequenceSet: PENTAGONAL_SET },
  { id: "PAT050210", name: "Hexagonal Number", sequenceSet: HEXAGONAL_SET },
  { id: "PAT050308", name: "Tetrahedral Number", sequenceSet: TETRAHEDRAL_SET },
  { id: "PAT050309", name: "Catalan Number", sequenceSet: CATALAN_SET },
  { id: "PAT050310", name: "Bell Number", sequenceSet: BELL_SET },
  { id: "PAT050408", name: "Factorial Number", sequenceSet: FACTORIAL_SET },
  { id: "PAT050409", name: "Fermat Number", sequenceSet: FERMAT_SET },
  { id: "PAT050410", name: "Perfect Number", sequenceSet: PERFECT_SET },
  { id: "PAT050508", name: "Leyland Number", sequenceSet: LEYLAND_SET },
  { id: "PAT050509", name: "Cayley Tree Number", sequenceSet: CAYLEY_TREE_SET },
  { id: "PAT050510", name: "Markov Number", sequenceSet: MARKOV_SET },
  { id: "PAT050608", name: "Highly Composite Number", sequenceSet: HIGHLY_COMPOSITE_SET },
  { id: "PAT050609", name: "Harmonic Divisor Number", sequenceSet: HARMONIC_DIVISOR_SET },
  { id: "PAT050610", name: "Wedderburn-Etherington Number", sequenceSet: WEDDERBURN_ETHERINGTON_SET }
].map((entry) => ({
  id: entry.id,
  name: entry.name,
  description: `Roll is a ${entry.name}`,
  requiredDigits: 5,
  baseMultiplier: () => 1000,
  ...
  evaluate(rollString, state) {
    if (!isInSequence(rollString, entry.sequenceSet)) return null;
...

  {
    ...
    evaluate(rollString, state) {
      ...
      const matchingGroup = groups.find((group) =>
        [...rollString].every((digit) => group.has(digit))
      );
