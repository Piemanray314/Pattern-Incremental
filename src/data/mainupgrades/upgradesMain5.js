...
const MATH_SEQUENCE_PATTERN_DATA = [
  { id: "PAT050108", title: "Fibonacci Number" },
  { id: "PAT050109", title: "Lucas Number" },
  { id: "PAT050110", title: "One-Sided Polyomino Number" },
  { id: "PAT050208", title: "Triangular Number" },
  { id: "PAT050209", title: "Pentagonal Number" },
  { id: "PAT050210", title: "Hexagonal Number" },
  { id: "PAT050308", title: "Tetrahedral Number" },
  { id: "PAT050309", title: "Catalan Number" },
  { id: "PAT050310", title: "Bell Number" },
  { id: "PAT050408", title: "Factorial Number" },
  { id: "PAT050409", title: "Fermat Number" },
  { id: "PAT050410", title: "Perfect Number" },
  { id: "PAT050508", title: "Leyland Number" },
  { id: "PAT050509", title: "Cayley Tree Number" },
  { id: "PAT050510", title: "Markov Number" },
  { id: "PAT050608", title: "Highly Composite Number" },
  { id: "PAT050609", title: "Harmonic Divisor Number" },
  { id: "PAT050610", title: "Wedderburn-Etherington Number" }
];

const MATH_SEQUENCE_PATTERN_UPGRADES = MATH_SEQUENCE_PATTERN_DATA.map((entry, index) =>
  makeUpgradePatternDefinition("PAT", 5, Math.floor(index / 3) + 1, (index % 3) + 8, entry.title, {
    cost: { points: { mantissa: 1, exponent: 75 + index } },
    maxLevel: 1,
    parents: ["UNL050009"],
...
// List of all upgrades in the main upgrade tree tab 3, 5-digit upgrades
export const UPGRADES_MAIN_5 = [
  {
    ...
    onBuy(state) {
      ...
      grantPrecisionRecastRoutingUpgrade(state, 5);
  ...
  makeUpgradeDefinition("UNL", 5, 0, 9, {
    title: "Patterns Pack: Mathematical Sequences",
  ...
  ...MATH_SEQUENCE_PATTERN_UPGRADES,
