...
export const changeLog = [
  ...
  },
  {
    ...
    entries: [
      "Offline progress!",
      "Made a new tab for automation settings with the introduction of cast automation",
      "Added more patterns (119 total)",
      "Rolls now show a text animation when clicked",
      "Rebalanced Shard Mitosis and added a few cast upgrades",
